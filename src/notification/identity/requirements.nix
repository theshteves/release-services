...
#
# COMMAND:
#   pypi2nix -v -C /tmp/release-services-lp05mj5m/src/notification/identity/../../../tmp/pypi2nix -V 3.7 -O ../../../nix/requirements_override.nix -E postgresql -s intreehooks -s flit -s vcversioner -s pytest-runner -s setuptools-scm -r requirements.txt -r requirements-dev.txt
#
...
let
  ...
  generated = self: {
    ...
    "boto3" = python.mkDerivation {
      name = "boto3-1.9.126";
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/57/7d/18b0cc2ff1a016873c639e4d82f54d596c1b99b6f557a3c9102c1520510a/boto3-1.9.126.tar.gz";
    ...
    "botocore" = python.mkDerivation {
      name = "botocore-1.12.126";
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/53/70/7955e2abaf33e26146601e929a3e5ae8f42f3bb57903ff8b81898b382fe6/botocore-1.12.126.tar.gz";
